...
DEFAULT_QUESTIONS = REPO_ROOT / "data" / "questions.csv"
DEFAULT_OUT_DIR = SAFETY_ROOT / "outputs"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate safety route against data/questions.csv.")
    parser.add_argument("--input", default=str(DEFAULT_QUESTIONS), help="Path to data/questions.csv")
