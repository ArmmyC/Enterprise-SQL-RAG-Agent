...
6. Evaluate กับ `data/questions.csv`
...
## Evaluate data/questions.csv

```powershell
python safety_route\scripts\evaluate_questions.py --input data\questions.csv
```
...
Latest MVP evaluation on `data/questions.csv`:
